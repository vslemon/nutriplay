...
import eu.vsl.nutriplay.SpinWheel.LuckyWheelView;
import eu.vsl.nutriplay.SpinWheel.model.LuckyItem;
import eu.vsl.nutriplay.databinding.ActivitySpinnerBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.spinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mLastActionTime = sp.getLong("last",0);
                if (currentTime - mLastActionTime  < 86400000) {

                    Toast.makeText(SpinnerActivity.this, "You can only spin once per day", Toast.LENGTH_SHORT).show();
                    return;
                }
                mLastActionTime = currentTime;
                editor.putLong("last", mLastActionTime);
                editor.commit();
